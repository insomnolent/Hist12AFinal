...
init -1 python hide:
    ...
    theme.bordered(
        ...
        mm_root = im.Scale("Title.png",800,600),
...
python early:
    config.save_directory = "Example-1455751044"
...
init python:
    ...
    build.directory_name = "History12A-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "History12A"
